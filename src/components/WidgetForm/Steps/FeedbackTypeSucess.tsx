...
export function FeedbackSucessStep({ onFeedbackRestartRequesed, }:FeedbackSucessStepProps) {
    return (
        <>
            <header>
                <CloseButton/>
            ...
            <div className='flex flex-col items-center py-10 w-[304px]'>
                ...
                <button type="button" onClick={onFeedbackRestartRequesed}
                    className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-7 hover:bg-zinc-700 focus:outline-none focus:ring-2 
                    focus:ring-offset-2
